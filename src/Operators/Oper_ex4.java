...
public class Oper_ex4 {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(halfmid); //Вывод значения для проверки корректности работы, по условию не нужен

        double result = Math.floor(halfmid);
        //System.out.println(result); //Вывод значения для проверки корректности работы, по условию не нужен
